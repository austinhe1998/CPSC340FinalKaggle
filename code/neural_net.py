...
class NeuralNet():
    ...
    def fit(self, X, y):
        ...
        self.classification = False # assume it's classification iff y has more than 1 column
        ...
        weights_flat_new, f = findMin.findMin(self.funObj, weights_flat, self.max_iter, X, y, verbose=3)
